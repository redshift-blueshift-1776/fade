...
public class GameManagerAutomatic : MonoBehaviour
{
    [SerializeField] private CityGeneratorAutomatic cityGenerator;
    ...
    private void Start()
    {
        willHelpPlayer = PlayerPrefs.GetInt("willHelpPlayer") == 1 ? true : false;
        timeUntilHelp = PlayerPrefs.GetInt("timeBeforeHelping");
        player.GetComponent<CharacterController>().enabled = false;
        player.transform.position = cityGenerator.getSafeSpawnLocationNearOrigin();
